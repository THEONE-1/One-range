  ...
  >
    <template #description>
      <a-typography-paragraph>
        场景：电子发票/配置文件上传接口，后端用 SAXBuilder 解析并展示摘要。
      </a-typography-paragraph>
      <a-typography-paragraph>
    ...
    <template #result v-if="result">
      ...
      <a-alert
        ...
        message="如果返回了文件内容，说明存在XXE漏洞，SAXBuilder加载了外部实体。"
        type="warning"
        show-icon
...
public class XXE {
    ...
    public String SAXBuilder(@RequestBody String content, String entity) {
      ...
      <a-alert
        message="漏洞点：SAXBuilder（jdom2库）默认允许加载外部实体，攻击者可以通过DOCTYPE声明加载外部资源。"
        type="error"
        show-icon
    ...
    <template #fix>
      ...
      <ul style="padding-left: 20px; line-height: 2;">
        <li><strong>禁用外部实体：</strong>设置SAXBuilder的setFeature禁用外部实体</li>
        <li><strong>使用XMLReader配置：</strong>通过XMLReader配置安全特性</li>
